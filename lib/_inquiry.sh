...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Myzapbot, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Myzapbot\n"
  printf "   [1] Atualizar Myzapbot\n"
  printf "   [2] Deletar Myzapbot\n"
  printf "   [3] Bloquear Myzapbot\n"
  printf "   [4] Desbloquear Myzapbot\n"
  printf "   [5] Alter. dominio Myzapbot\n"
  printf "\n"
  read -p "> " option
